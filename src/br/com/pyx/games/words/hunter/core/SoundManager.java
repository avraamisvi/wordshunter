...
public class SoundManager {
	...
	{
		mSoundPoolMap.put(EVOLUI, mSoundPool.load(mContext, R.raw.evoluiu, 1));
		mSoundPoolMap.put(EXPLOSION, mSoundPool.load(mContext, R.raw.explosion, 1));
		mSoundPoolMap.put(SUBMIT, mSoundPool.load(mContext, R.raw.submete_ok, 1));
	}
